from Crypto.Cipher import AES    # tools for algorithms for encrypting and decrypting 
from Crypto.Random import get_random_bytes
import base64    # Convert binary -> safe string
import hashlib   # Python library used to apply hashing like SHA-256
...
def derive_key(password):
    return hashlib.sha256(password.encode()).digest()  # SHA-256- One Way Hshing Algorithm 
